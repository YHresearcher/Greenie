...
const RECAPTCHA_SITE_KEY = ""; // set your real site key before production
...
bindEmailForm(contactForm, statusText, EMAILJS_TEMPLATE_ID);
bindEmailForm(sampleForm, sampleStatusText, "template_stjny2d");
>>>>>>> afe65c1 (fix: remove integrity attributes from script tags for Tailwind CSS and AOS, and update Privacy Policy link ID)
