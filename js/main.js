...
const translations = {
    en: {
        ...
        "inquiry.eyebrow": "Send an inquiry",
   ...
   zh: {
      ...
      "tea.origin": "越南河江",
      "tea.title": "山雪古树茶",
      "tea.copy": "来自河江雾霭高原200年以上古茶树的野生古树茶。手工采摘，传统工艺，面向高端茶叶零售商和自有品牌。",
      "tea.spec1Label": "等级",
      "tea.spec1": "一芽二叶",
      "tea.spec2Label": "包装",
    ...
    hi: {
      ...
      "nav.oem": "OEM",
      "nav.inquiry": "पूछताछ",
      "cta.inquiry": "Inquiry भेजें",
      "cta.startOem": "OEM शुरू करें",
      "cta.submitOem": "OEM ब्रीफ भेजें",
      "cta.samplesViaForm": "Inquiry फॉर्म से नमूने मांगें",
